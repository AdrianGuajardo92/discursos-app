...
export default function VistaBosquejo({
  discurso,
  onVolver,
  onModoDiscurso,
  theme,
  ...
  return (
    <>
      <div style={{ background: C.card, borderBottom: `1px solid ${C.border}`, padding: "8px 14px", position: "sticky", top: 0, zIndex: 50, display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <span style={{ flex: 1, fontSize: 11, color: C.dim, textAlign: "center" }}>{topLabel || `Nº${discurso.numero}`}</span>
